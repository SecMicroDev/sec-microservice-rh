...
class Enterprise(BaseIDModel, BaseEnterprise, table=True):
    ...
    users: Optional[list["User"]] = Relationship(back_populates="enterprise", sa_relationship_kwargs=dict(cascade="all, delete-orphan"))
    scopes: Optional[list["Scope"]] = Relationship(back_populates="enterprise", sa_relationship_kwargs=dict(cascade="all, delete-orphan"))
    roles: Optional[list["Role"]] = Relationship(back_populates="enterprise", sa_relationship_kwargs=dict(cascade="all, delete-orphan"))
